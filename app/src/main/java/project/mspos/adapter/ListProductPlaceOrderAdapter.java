...
public class ListProductPlaceOrderAdapter extends RecyclerView.Adapter<RecyclerListViewHolders> {
    ...
    public ListProductPlaceOrderAdapter(Activity context, List<ProductEntity> listProduct) {
